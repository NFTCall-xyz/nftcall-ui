...
import type { NFTSettingForm, NFTSettingFormProps } from '../types'
...
const getInitialValues = (nft: Partial<NFT> = {}): NFTSettingForm => {
  const {
...
export const useForm = ({ nft, formikStorage }: NFTSettingFormProps) => {
