const locale = {
  ...
  stats: {
    ...
    claimableTip:
      'Your income consists of two parts, denominated in ETH, one from the option premium and the other from the strike price paid by the options buyer when the option is exercised. All your income will be stored in the contract and you need to claim your earnings mannually.',
    accruedEarnings: 'Accrued Earnings',
    accruedEarningsTip: 'Your historical total earnings from the options selling.',
    claim: 'Claim',
    APY: 'Estimated APY',
    APYTip:
      'Estimated APY is calculated based on your total yield and the total duration of options sold. APY = Total yield / Total duration * 365 * 100%',
  },
  callPools: {
