...
const createToastByType = (type: string) => (content: ToastContent, options?: ToastOptions) =>
...
function handlePromise<T>(
  ...
  const resolver = (type: TypeOptions, input: string | UpdateOptions, result: T) => {
    const baseParams = {
      type,
      ...resetParams,
      ...options,
...
toast.primary = createToastByType(TYPE.SUCCESS)
toast.secondary = createToastByType(TYPE.SECONDARY)
