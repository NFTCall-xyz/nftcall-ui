...
export interface BaseImmutableAdminUpgradeabilityProxyInterface extends utils.Interface {
  functions: {
...
export interface BaseImmutableAdminUpgradeabilityProxy extends BaseContract {
