...
export interface InitializableImmutableAdminUpgradeabilityProxyInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'admin' | 'implementation' | 'initialize' | 'upgradeTo' | 'upgradeToAndCall'
  ): FunctionFragment
...
export interface InitializableImmutableAdminUpgradeabilityProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: InitializableImmutableAdminUpgradeabilityProxyInterface
